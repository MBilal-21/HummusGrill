...
useEffect(() => {
    ...
    else if (show === "/dashboard/profile") {
 
      linktabP.current.classList.add("active");
      linktabH.current.classList.remove("active");
    }
    else if (show === "/dashboard/ordered-history") {
        ...
        <Row>
          <Col xs={12} md={3} lg={2}>
            <ul className="d-flex flex-column align-items-center text-center dashTab">
              <li className="w-100">
                <NavLink className="tab" to={"profile"} ref={linktabP} >
                  <i
              ...
              <li className="w-100">
                <NavLink className=" tab" to={"ordered-history"} ref={linktabH}>
                  <PersonSharpIcon
                    className="mx-auto"
                    style={{ fontSize: "25px" }}
                  />
